describe("jsCronUI", function(){
    ...
    describe("should translate a CRON schedule", function() {
        ...
        it("for every week correctly", function () {
            ...
            var cronHumanTextInEnglish = "Every week on Sunday and Wednesday at 2:23 PM";
        ...
        it("for every month correctly", function () {
            ...
            var cronHumanTextInEnglish = "Every month on the 26th at 9:52 AM";
        ...
        it("for every year correctly", function () {
            ...
            var cronHumanTextInEnglish = "Every year on May 3rd at 9:34 PM";
        ...
        it("for the specific day of a year correctly", function () {
            ...
            var cronHumanTextInEnglish = "Every year on November 14th at 10:18 PM";
        ...
        it("for every month on a specific day as outlined by quartz", function () {
            ...
            var cronHumanTextInEnglish = "Every month on the 15th at 10:15 AM";
        ...
        it("for every year on a specific day as outlined by quartz", function () {
            ...
            var cronHumanTextInEnglish = "Every year on November 11th at 11:11 AM";
        ...
        it("for every year on the last day of a month", function(){
            ...
            var cronHumanTextInEnglish = "Every year on the last Friday of January and April at 11:25 AM";
    ...
    describe("should correctly intrepret interface", function() {
        ...
        it("for every week", function () {
            ...
            var englishString = "Every week on Sunday, Monday, Tuesday, Wednesday and Thursday at 10:20 AM";
        ...
        it("for specific range of days of the month", function () {
            ...
            var englishString = "Every month on the 8th-11th at 8:52 AM";
        ...
        it("for specific days of the month", function () {
            ...
            var englishString = "Every month on the 8th, 14th and 26th at 9:52 AM";
        ...
        it("for every year on a specific day", function () {
            var cronExp = "0 34 21 3 5 ? *";
            var englishString = "Every year on May 3rd at 9:34 PM";
        ...
        it("for every year on multiple days", function () {
            ...
            var englishString = "Every year on July 3rd and 6th at 9:18 PM";
        ...
        it("for every year on a specific occurrence of multiple months", function () {
            ...
            var englishString = "Every year on the fourth Saturday of January, February and March at 9:12 PM";
